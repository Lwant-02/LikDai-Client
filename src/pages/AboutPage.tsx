...
import { Keyboard, Award, BarChart, Quote, Sparkles } from "lucide-react";
        ...
        >
          ...
          >
            <p className="text-lg sm:text-xl opacity-90 leading-relaxed">
              LikDai-Pro is a specialized typing platform designed to help users
              master Shan language typing. Inspired by MonkeyType, we've created
              a clean, distraction-free environment where you can practice and
              improve your typing skills in both English and Shan languages.
            </p>
